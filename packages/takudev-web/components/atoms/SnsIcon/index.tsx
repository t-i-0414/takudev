...
export const SnsIcon: React.FC<Props> = React.memo(
  ({ type, colorName: color, ...rest }) => {
    ...
    const ariaLabel = useMemo(() => {
      switch (type) {
        case 'github':
          return "jump to Takuya Iwashiro's gitHub page";
        case 'twitter':
          return "jump to Takuya Iwashiro's twitter page";
        case 'facebook':
          return "jump to Takuya Iwashiro's facebook page";
        case 'linkedin':
          return "jump to Takuya Iwashiro's linkedin page";
        case 'rss':
          return "jump to Takuya Iwashiro's rss page";
        default:
          return '';
      }
    }, [type]);
